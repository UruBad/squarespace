...
var select_size;
 var trimirror_clientId = clientId;
    ...
    function UpdatePage() {
    	var sideBySideInfo = '<div class="yui3-widget sqs-widget sqs-widgets-confirmation alert shown" style="display:none" id="side_by_side_info"><div class="sqs-widgets-confirmation-content clear"><div class="title">Virtual fitting example</div><div class="message">Click here to <a href="/my-avatar">create your avatar</a></div><div class="buttons"><div class="confirmation-button no-frame confirm" tabindex="3">Okay</div></div></div></div>';
