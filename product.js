...
var select_size;
 var trimirror_clientId = clientId;
	...
	$("#productSlideshow").parent().append('<div id="trimirror_logo" style="background-position:63px 0 !important;display:none;z-index:889;-webkit-transform: rotate(270deg);-moz-transform: rotate(270deg);-o-transform: rotate(270deg);-ms-transform: rotate(270deg);transform: rotate(270deg);left:-10% !important;left:auto !important;bottom:15% !important;line-height:21px;" class="trimirror_logo"><a class="touch_click" href="http://trimirror.com" target="_blank"><div><span>powered by</span><span>tri</span><span>Mirror</span></div></a></div>');
