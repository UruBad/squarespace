...
var select_size;
 var trimirror_clientId = clientId;
	...
	contentSmall += '<div class="shop-product-single-social" style="margin-top:10px;width:90%;"><div class="social-widget social-widget-mini social-widget-dark" style="float:right"><ul class="list-inline"><li><a href="https://www.facebook.com/sharer/sharer.php?u=' + window.location.href + '" id="facebook_share" onclick=" window.open(this.href, \'facebook-share\', \'width=580,height=296\'); return false; " rel="nofollow" title="Facebook" class="fb"> <span class="sr-only">Facebook</span> </a></li>';
	contentSmall += '<li> <a href="http://twitter.com/share?text=CreateIT&amp;url=' + window.location.href + '" id="twitter_share" onclick=" window.open(this.href, \'twitter-share\', \'width=550,height=235\'); return false;" rel="nofollow" title=" Share on Twitter" class="tw"> <span class="sr-only">Twitter</span></a></li>';
	contentSmall += '<li><a href="https://pinterest.com/pin/create/button/?url=' + window.location.href + '&amp;media=#media#" id="pinterest_share" onclick=" window.open(this.href, \'pinterest-share\', \'width=490,height=530\'); return false;" rel="nofollow" title="Pinterest" class="pt"><span class="sr-only">Pinterest</span></a></li>';
	contentSmall += '<li> <a href="#" id="youtube_share" rel="nofollow" title="Youtube" class="yt youtube_share"><span class="sr-only">Youtube</span></a><span id="youtube_percent" style="display:none;font-size:16px;"></span></li></ul></div></div>';
	contentSmall += "</div>";
