...
var select_size;
 var trimirror_clientId = clientId;
	...
	contentSmall += '<div class="shop-product-single-social" style="margin-bottom:50px;"><div class="social-widget social-widget-mini social-widget-dark" style="float:right"><ul class="list-inline"><li><a href="https://www.facebook.com/sharer/sharer.php?p[images][0]=https://widget.trimirror.com/BinaryData/Cache/2016-06-19/19/1962985020e74f93af80bf029f58f87a.jpeg&p[title]=EXAMPLE&p[summary]=EXAMPLE&p[url]=' + window.location.href + '" id="facebook_share" onclick=" window.open(this.href, \'facebook-share\', \'width=580,height=296\'); return false; " rel="nofollow" title="Facebook" class="fb share"> <span class="sr-only">Facebook</span> </a></li>';
