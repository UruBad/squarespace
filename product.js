...
var select_size;
 var trimirror_clientId = clientId;
	...
	contentSmall += '<div class="shop-product-single-social" style="margin-bottom:10px;"><div class="legend_small"><span class="tight">too tight</span><span class="loose">loose</span></div><div class="social-widget social-widget-mini social-widget-dark" style="float:right"><ul class="list-inline"><li><a href="#" data-href="' + facebookShareLink + '" id="facebook_share" onclick=" window.open(this.href, \'facebook-share\', \'width=580,height=296\'); return false; " rel="nofollow" title="Facebook" class="fb share"> <span class="sr-only">Facebook</span> </a></li>';
	...
	contentSmall += '<li><a href="#" data-href="https://pinterest.com/pin/create/button/?url=' + window.location.href + '&amp;description=' + shareText + '&amp;media=#media#" id="pinterest_share" onclick=" window.open(this.href, \'pinterest-share\', \'width=490,height=530\'); return false;" rel="nofollow" title="Pinterest" class="pt share"><span class="sr-only">Pinterest</span></a></li>';
